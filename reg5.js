$(function() {
    ...
    function check_mphone() {
        ...
        if (mphone == '') {
           ...
           $("#mphone").css("border","3px solid #F90A0A");
           error_mphone = false;
        }
        else if (!pattern.test(mphone) ) {
           $("#demo4").show();
           ...
           $("#demo4").hide();
           $("#mphone").css("border","3px solid green");
        }
     }
    ...
    function check_pass() {
       ...
       if (pass== '') {
          $("#demo6").show();
          $("#demo6").html("Please Enter Password");
    ...
    $("#form").submit(function() {
       ...
       if (error_name === true && error_lname === true && error_address === true&& error_email === true && error_mphone === true && error_uname === true &&  error_pass === true && error_cpass === true) {
