...
<body id="page-top">
 ...
 <form action="vehiclemodel.php" method="POST" name="frm" id="form" >
<div class="error"><p id="demo"></p></div>
<table >
<tr>
<td><label> Vehicle Model</label></td>
<td class="tdi"><input type="text" placeholder="Enter Model Name" name="vmodel" id="vmodel" autocomplete="off">
...
{
$vmodel=$_POST["vmodel"];
$sql2="select * from vmodel_tbl where vmodel='$vmodel' ";
...
if($vcount>0)
{
  ...
  {
    $sql="insert into vmodel_tbl(vmodel)values('$vmodel')";
