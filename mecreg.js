$(function() {
    ...
    function check_name() {
       ...
       if (name == '') {
          ...
          $("#demo1").show();
          $("#demo1").html("Contain only Characters");
          $("#name").css("border","3px solid #F90A0A");
          error_name = false;
       } else {
          $("#demo1").hide();
    ...
    $("#form").submit(function() {
       ...
       if (error_name === true&& error_address === true&& error_email === true && error_phone === true && error_uname === true &&  error_pass === true && error_cpass === true) {
