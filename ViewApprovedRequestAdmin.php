       ...
       <?php
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Approved Request</h1>
            <ol class="breadcrumb">
...
<thead>
<tr>
<th><center><strong>Req_id</strong></center></th>
...
$sel_query="select * from request_tbl rq,reg_tbl re,mec_tbl m,assign_tbl a where rq.req_id=a.req_id and re.log_id=a.log_id and m.mec_id=a.mechanic ORDER By ass_id";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<td><center><?php echo $row["req_id"]; ?><center></td>
