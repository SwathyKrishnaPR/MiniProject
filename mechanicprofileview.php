...
$r=mysqli_fetch_array($res);
?>
<form action="mechanicprofileedit.php" method="POST" name="frm" id="form" class="frm" >
...
<td class="tdi"><center><input type="text" class ="in"placeholder="Enter The Phone Number"id ="phone" name="phone"autocomplete="off" value="<?php echo $r['phone'];?>"></center></td>
</tr>
<tr>
...
<a href="mechanicprofileedit.php" class="button1">Edit Profile</a>
<a href="mechanicprofileview.php" class="button2">Cancel</a>
