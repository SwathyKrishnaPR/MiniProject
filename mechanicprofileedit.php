...
<head>
  ...
  crossorigin="anonymous"></script>
    <script type="text/javascript" src="js/userprofileedit.js"> </script>
</head>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="request.php">Send Request</a>
            <a class="collapse-item" href="buttons.html">Request Status</a>
            <a class="collapse-item" href="dropdowns.html">Track Request</a>
            <a class="collapse-item" href="modals.html">Cancel Request</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="mecreg.php">view Status</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="simple-tables.html">Pay Bill</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="register.html">Book Vehicle</a>
            <a class="collapse-item" href="404.html">View Vehicle</a>
            <a class="collapse-item" href="register.html">View Payment</a>
          </div>
        </div>
      </li>
    </ul>
...
$id=$_SESSION['log_id'];
$query5 ="SELECT * FROM mec_tbl , log_tbl WHERE log_tbl.log_id ='$id' AND mec_tbl.log_id=log_tbl.log_id";  
...
<td class="tdi"><center><input type="text" class ="in" placeholder="Enter The Email Id" id="email" name="email" autocomplete="off" value="<?php echo $r['email'];?>"></center>
<div class="error"><p id="demo3"></p></div>
</td>
</tr>
<tr>
<th><center><strong>Phone Number</strong></center></th>
<td class="tdi"><center><input type="text" class ="in" placeholder="Enter The Phone Number"id ="phone" name="phone"autocomplete="off" value="<?php echo $r['phone'];?>"></center>
...
$email1=$_POST['email'];
$phone1=$_POST['phone'];
$sql2="UPDATE mec_tbl SET name = '$name1' ,address='$address1' , email='$email1' , phone='$phone1' WHERE log_id='$id'";
