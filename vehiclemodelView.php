...
<th><center><strong>Vehicle_id</strong></center></th>
<th><center><strong>Vehicle_id</strong></center></th>
...
<?php
$count=1;
$sel_query="SELECT * FROM vmodel_tbl"; 
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td><center><?php echo $count; ?></center></td>
<td><center><?php echo $row["vm_id"]; ?></center></td>
<td><center><?php echo $row["vmodel"]; ?></center></td>
<td><center>
<a href="vehicledelete.php?id=<?php echo $row["vm_id"];?>">Delete</a>
</center></td>
